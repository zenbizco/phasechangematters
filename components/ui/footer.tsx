      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8 pb-8 border-b border-neutral-700">
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-neutral-400 hover:text-blue-500 transition-colors">Cold Chain</a></li>
              <li><a href="#" className="text-neutral-400 hover:text-blue-500 transition-colors">Building Materials</a></li>
              <li><a href="#" className="text-neutral-400 hover:text-blue-500 transition-colors">Data Centers</a></li>
              <li><a href="#" className="text-neutral-400 hover:text-blue-500 transition-colors">Transportation</a></li>
            </ul>
          </div>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2 text-neutral-400">
              ...
              <li className="flex items-center">
                ...
                <span>info@phasechangematters.com</span>
              </li>
              <li className="flex items-center">
                <svg className="w-5 h-5 mr-2 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <a href="tel:14158727100" className="hover:text-blue-400 transition-colors">(415) 872-7100</a>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center py-4">
          ...
          <div className="flex gap-6">
            <button onClick={() => scrollToSection('privacy')} 
              className="text-sm text-neutral-500 hover:text-blue-500 transition-colors">
              Privacy Policy
            </button>
            ...
            <a href="#" className="text-sm text-neutral-500 hover:text-blue-500 transition-colors">
              Sitemap
            </a>
          </div>
        </div>
