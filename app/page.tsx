...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section id="contact" className="py-16 px-4 sm:px-6 lg:px-8 w-full max-w-6xl mx-auto">
        <Card className="shadow-lg w-full py-16">
          <CardHeader className="text-center">
            <CardTitle className="text-3xl">Request Information or Quote</CardTitle>
